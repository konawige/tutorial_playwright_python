...
from behave.api.async_step import async_run_until_complete, use_or_create_async_context
...
@async_run_until_complete
async def is_title_page_contains(context):
    login_page = LoginPage(context.page)
    assert await login_page.is_title_contains("Login")
